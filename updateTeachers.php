...
$sql="UPDATE teachers SET image='$image' , id=$id , tid=$tid , fullname='$fullname' , ininame='$ininame' , address='$address', dob='$dob',gender='$gender', mobile=$mobile, fixed=$fixed WHERE id=$id";
//echo $sql;
