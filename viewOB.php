...
<h2 style="text-align: center; font-size: 70px; ">View All OB Students</h2>
...
?>
	...
	<table , th, td style="border: 1px solid black;
		...
		<tr>
				...
				<td><img src="http://localhost/NIBMProject/ob/<?php echo  $d['image']; ?>" style="height: 100px; width: 100px;"></td>
				<td><?php echo $d['id']; ?></td>
				...
				<td><?php echo $d['entryyear']; ?></td>
				<td><?php echo $d['outyear']; ?></td>
				<td><?php echo $d['mobile']; ?></td>
				<td><?php echo $d['fixed']; ?></td>
				<td><?php echo $d['lifetime']; ?></td>
  ...
  <div class="column right" style="background-color:#FFF8DC;">
    ...
    <form method="post" action="viewSearchOB.php" name="form" >
	<h1>Search OB</h1>
